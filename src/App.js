...
const App = () => (
  <div className="CardBriefing">
    <Card title="React Dev Test">
      <p>
        O candidato deve ser capaz de criar um aplicação DASHBOARD usando React,
        com Ant Design, Router e Redux.
      </p>
        ...
        <li>
          ...
          <ul>
            <li
              ...
              data-line-end="25"
            >
              Ao selecionar um usuário abrir Form Cadastro do usuário e podendo
              remover e alterar ou voltar para a tabela.
            </li>
          </ul>
        </li>
      </ul>
      ...
      <p>
        A MAINVIEW do dashboard deve ser comandada por um SIDEBAR com o seguinte
        menu:
      </p>
        ...
        <li>
          ...
          <ul>
            <li
              ...
              data-line-end="32"
            >
              Monstrar 5 Primeiro Usuários da Tabela de Usuário com link para a
              seu Form Cadastro
            </li>
          </ul>
        </li>
